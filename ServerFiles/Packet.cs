...
{
    /// <summary>
    /// Organiser for codes send from here to clients, clients must have a handle attached to each code
    /// </summary>
    ...
    /// <summary>
    /// Organiser for codes sent from client to here, Server must have handles attached to each code
    /// </summary>
