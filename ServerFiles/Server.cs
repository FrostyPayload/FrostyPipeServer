    ...
    public static class Server
    {
        ...
        async static void PostServerToHub(string url)
        {
            ...
            Dictionary<string, string> dict = new Dictionary<string, string>()
            {
                ...
                {"tick_rate", Servermanager.TicksPerSecMax.ToString() },
            ...
            while (badgateway)
            {
                ...
                HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://checkip.dyndns.org/");
                    try
                    {
                        ...
                        badgateway = response.StatusCode == HttpStatusCode.BadGateway ? true : false;
        ...
        public static void DisconnectPlayerAndCleanUp(uint ClientThatDisconnected)
        {
            ...
            foreach (uint watch in TimeoutWatches.Keys.ToList())
            {
